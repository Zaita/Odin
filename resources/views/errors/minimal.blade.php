...
<html lang="en">
    <head>
        ...
        <style>
            ...
            html{line-height:1.5}*,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}
            ...
            .flex{display:flex}
            .grid{display:grid}
            .hidden{display:none}.items-center{align-items:center}
            ...
            }.max-w-xl{max-width:36rem}.max-w-6xl{max-width:72rem}.min-h-screen{min-height:100vh}
            .overflow-hidden{overflow:hidden}.p-6{padding:1.5rem}.py-4{padding-top:1rem;padding-bottom:1rem}
