        ...
        <div className="flex mr-auto">
          ...
          <div className="flex ml-auto" style={{paddingTop: "10px"}}>
            ...
            {topMenuItems.map && topMenuItems.map((item, index) => {
              if (item.length == 3) {
                return (<div key={index} className="min-w-24 table-cell text-center border-l-2 pl-1 pr-1"
                  style={{borderColor: siteConfig.theme_admin_topmenu_item_border_color, color: siteConfig.theme_admin_topmenu_item_text_color}}>
