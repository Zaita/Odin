...
export default function Admin_CheckBox(props) {
  const [isFocused, setIsFocused] = useState(false);
  const [value, setValue] = useState(props.field.value == null ? false : props.field.value);
  ...
  return (
    <div id="input_field">
      ...
      <input type="checkbox" name={camalCase(fieldId)} id={fieldId} value={value} onKeyUp={handleKeyPress}
