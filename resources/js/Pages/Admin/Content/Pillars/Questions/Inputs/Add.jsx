...
export default function AnswerInputField(props) {
  console.log("Pillar.Question.Inputs.Add");
  ...
  function handleChange(id, value) {
    console.log(`Input.add = id: ${id}; value: ${value}`);
  ...
  function saveAnswersCallback() {
    ...
    SaveAnswersWithId("admin.content.pillar.question.input.create", {id:props.pillar.id, questionId:props.question.id}, setSaveOk, setSaveErrors, userAnswers.current);
  }
  ...
  let requiredField = {
    "label" : "Required",
    "value" : getValue(props.field?.required, "required", false),
    "visibility" : true
  }
  ...
  let placeholderField = {
    ...
    "placeholder": "256",
    "required": false,
    "value": getValue(props.field?.place_holder, "placeholder")
  }
