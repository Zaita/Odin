...
export default function TaskEditQuestion(props) {  
  ...
  function saveAnswersCallback() {
    userAnswers.current["taskId"] = props.task.id;
    userAnswers.current["questionId"] = props.question.id;
    SaveAnswersWithId("admin.content.task.question.update", {id:props.task.id, questionId:props.question.id}, setSaveOk, setSaveErrors, userAnswers.current)
  }
