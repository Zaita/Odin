...
export default function LatestSubmissions(props) {
  return (
    <div id="latest_submissions" className="mb-4">
      ...
      <div className="w-full flex p-2 mb-1" style={{backgroundColor: props.siteConfig.theme_content_bg_color}}>
      ...
      {props.latestSubmissions.map((submission, index) => (
        <div className="w-full flex mb-1 p-1" style={{backgroundColor: props.siteConfig.theme_content_bg_color}} key={index}>
